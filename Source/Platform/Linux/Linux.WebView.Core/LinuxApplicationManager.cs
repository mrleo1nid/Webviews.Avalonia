...
public class LinuxApplicationManager
{
    static LinuxApplicationManager()
    {
        ...
        _libraryDefinitions[gLibrary.GLib] = new string[4]
        {
            "libglib-2.0-0.dll",
            "libglib-2.0.so.0",
            "libglib-2.0.0.dylib",
        ...
        _libraryDefinitions[gLibrary.GObject] = new string[4]
        {
        ...
        _libraryDefinitions[gLibrary.Cairo] = new string[4]
        {
            "libcairo-2.dll",
            "libcairo.so.2",
            "libcairo.2.dylib",
        ...
        _libraryDefinitions[gLibrary.Gio] = new string[4]
        {
            "libgio-2.0-0.dll",
            "libgio-2.0.so.0",
            "libgio-2.0.0.dylib",
        ...
        _libraryDefinitions[gLibrary.Atk] = new string[4]
        {
            "libatk-1.0-0.dll",
            "libatk-1.0.so.0",
            "libatk-1.0.0.dylib",
        ...
        _libraryDefinitions[gLibrary.Pango] = new string[4]
        {
            "libpango-1.0-0.dll",
            "libpango-1.0.so.0",
        ...
        _libraryDefinitions[gLibrary.Gdk] = new string[4]
        {
            "libgdk-3-0.dll",
            "libgdk-3.so.0",
            "libgdk-3.0.dylib",
        ...
        _libraryDefinitions[gLibrary.GdkPixbuf] = new string[4]
        {
        ...
        _libraryDefinitions[gLibrary.Gtk] = new string[4]
        {
            "libgtk-3-0.dll",
            "libgtk-3.so.0",
            "libgtk-3.0.dylib",
        ...
        _libraryDefinitions[gLibrary.PangoCairo] = new string[4]
        {
        ...
        _libraryDefinitions[gLibrary.GtkSource] = new string[4]
        {
        ...
        _libraryDefinitions[gLibrary.Webkit] = new string[4]
        {
    ...
    static nint Load(gLibrary library)
    {
        ...
        throw new DllNotFoundException(
            library.ToString() + ": " + string.Join(", ", _libraryDefinitions[library])
        );
    }
